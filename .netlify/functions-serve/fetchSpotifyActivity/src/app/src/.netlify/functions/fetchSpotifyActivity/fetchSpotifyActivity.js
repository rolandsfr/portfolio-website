...
// app/src/.netlify/functions/fetchSpotifyActivity/fetchSpotifyActivity.ts
...
var handler = async (event) => {
  ...
  let access_token;
  try {
    let auth = await import_axios.default.post(`https://accounts.spotify.com/api/token`, {
      method: "POST",
...
//# sourceMappingURL=fetchSpotifyActivity.js.map
